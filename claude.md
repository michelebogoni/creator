...
```
 ...
 WP CODE FALLBACK STRATEGY UNDEFINED
 ...
 AI FILE ATTACHMENT AWARENESS UNCLEAR
...
VERIFY:
- All 3 phases execute
- Code is executable PHP
- No hardcoded actions used
...
VERIFY:
- AI reads and analyzes attached image
- AI references design in responses
...
VERIFY:
- Error detected
- AI retries with different approach
...
- Details loaded from repository
- AI uses loaded details
- Code uses correct functions
```
